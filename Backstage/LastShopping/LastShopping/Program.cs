...
app.Use(async (context, next) =>
{
    ...
    context.Response.Headers.Add(
        ...
        "base-uri 'none'; block-all-mixed-content; child-src 'none'; connect-src 'self' wss:; default-src 'none'; font-src 'none'; form-action 'self'; frame-ancestors 'none'; frame-src 'none'; img-src 'self' data: 'none'; manifest-src 'none'; media-src 'none'; object-src 'none'; sandbox allow-downloads allow-forms allow-modals allow-same-origin allow-scripts; script-src 'self' 'unsafe-inline' 'unsafe-eval' 'none'; script-src-attr 'unsafe-inline'; script-src-elem 'self' 'unsafe-inline' 'none'; style-src 'self' 'unsafe-inline' 'none'; style-src-attr 'unsafe-inline'; style-src-elem 'self' 'unsafe-inline' 'none'; upgrade-insecure-requests; worker-src 'none';"
    );
    await next();
});
